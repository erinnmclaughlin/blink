...
{
    public const string Collections = nameof(Collections);
    public const string ContinueWatching = nameof(ContinueWatching);
    public const string DeleteVideos = nameof(DeleteVideos);
    public const string EditVideoDetails = nameof(EditVideoDetails);
